...
public struct FoundationModule: BuiltinModule {
    ...
    private func registerStringMethods(into i: Interpreter) {
        i.registerMethod(on: "String", name: "replacingOccurrences") { recv, args in
            guard args.count == 2,
        ...
        i.registerMethod(on: "String", name: "padding") { recv, args in
        ...
        i.registerMethod(on: "String", name: "components") { recv, args in
            guard case .string(let s) = recv else {
