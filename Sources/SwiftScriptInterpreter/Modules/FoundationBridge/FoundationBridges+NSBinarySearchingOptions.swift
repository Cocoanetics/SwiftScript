...
extension FoundationBridges {
    ...
    "func NSBinarySearchingOptions.union()": .method { receiver, args in
    ...
    "func NSBinarySearchingOptions.intersection()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func NSBinarySearchingOptions.symmetricDifference()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func NSBinarySearchingOptions.contains()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func NSBinarySearchingOptions.isSubset()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func NSBinarySearchingOptions.isSuperset()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func NSBinarySearchingOptions.isDisjoint()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func NSBinarySearchingOptions.subtracting()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func NSBinarySearchingOptions.isStrictSuperset()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func NSBinarySearchingOptions.isStrictSubset()": .method { receiver, args in
        guard args.count == 1 else {
