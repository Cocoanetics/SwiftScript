...
extension FoundationBridges {
    ...
    "func FileManager.removeItem()": .method { receiver, args in
        ...
        let recv: FileManager = try unboxOpaque(receiver, as: FileManager.self, typeName: "FileManager")
        do {
            try recv.removeItem(atPath: try unboxString(args[0]))
            return .void
        } catch {
            throw UserThrowSignal(value: .opaque(typeName: "Error", value: error))
        }
    ...
    "func FileManager.startDownloadingUbiquitousItem()": .method { receiver, args in
        ...
        let recv: FileManager = try unboxOpaque(receiver, as: FileManager.self, typeName: "FileManager")
        do {
            try recv.startDownloadingUbiquitousItem(at: try unboxOpaque(args[0], as: URL.self, typeName: "URL"))
            return .void
        } catch {
            throw UserThrowSignal(value: .opaque(typeName: "Error", value: error))
        }
    ...
    "func FileManager.evictUbiquitousItem()": .method { receiver, args in
        ...
        let recv: FileManager = try unboxOpaque(receiver, as: FileManager.self, typeName: "FileManager")
        do {
            try recv.evictUbiquitousItem(at: try unboxOpaque(args[0], as: URL.self, typeName: "URL"))
            return .void
        } catch {
            throw UserThrowSignal(value: .opaque(typeName: "Error", value: error))
        }
    ...
    "func FileManager.createSymbolicLink()": .method { receiver, args in
        ...
        let recv: FileManager = try unboxOpaque(receiver, as: FileManager.self, typeName: "FileManager")
        do {
            try recv.createSymbolicLink(at: try unboxOpaque(args[0], as: URL.self, typeName: "URL"), withDestinationURL: try unboxOpaque(args[1], as: URL.self, typeName: "URL"))
            return .void
        } catch {
            throw UserThrowSignal(value: .opaque(typeName: "Error", value: error))
        }
    ...
    "func FileManager.copyItem()": .method { receiver, args in
        ...
        let recv: FileManager = try unboxOpaque(receiver, as: FileManager.self, typeName: "FileManager")
        do {
            try recv.copyItem(atPath: try unboxString(args[0]), toPath: try unboxString(args[1]))
            return .void
        } catch {
            throw UserThrowSignal(value: .opaque(typeName: "Error", value: error))
        }
    ...
    "func FileManager.moveItem()": .method { receiver, args in
        ...
        let recv: FileManager = try unboxOpaque(receiver, as: FileManager.self, typeName: "FileManager")
        do {
            try recv.moveItem(atPath: try unboxString(args[0]), toPath: try unboxString(args[1]))
            return .void
        } catch {
            throw UserThrowSignal(value: .opaque(typeName: "Error", value: error))
        }
    ...
    "func FileManager.linkItem()": .method { receiver, args in
        ...
        let recv: FileManager = try unboxOpaque(receiver, as: FileManager.self, typeName: "FileManager")
        do {
            try recv.linkItem(atPath: try unboxString(args[0]), toPath: try unboxString(args[1]))
            return .void
        } catch {
            throw UserThrowSignal(value: .opaque(typeName: "Error", value: error))
        }
    ...
    "func FileManager.createDirectory()": .method { receiver, args in
        ...
        let recv: FileManager = try unboxOpaque(receiver, as: FileManager.self, typeName: "FileManager")
        do {
            try recv.createDirectory(at: try unboxOpaque(args[0], as: URL.self, typeName: "URL"), withIntermediateDirectories: try unboxBool(args[1]))
            return .void
        } catch {
            throw UserThrowSignal(value: .opaque(typeName: "Error", value: error))
        }
