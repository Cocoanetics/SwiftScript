...
extension FoundationBridges {
    ...
    "func CharacterSet.isSubset()": .method { receiver, args in
    ...
    "func CharacterSet.isDisjoint()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func CharacterSet.isStrictSuperset()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func CharacterSet.isStrictSubset()": .method { receiver, args in
        guard args.count == 1 else {
