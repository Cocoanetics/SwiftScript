...
extension FoundationBridges {
    static let nSEnumerationOptions: [String: Bridge] = [
    ...
    "func NSEnumerationOptions.union()": .method { receiver, args in
    ...
    "func NSEnumerationOptions.intersection()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func NSEnumerationOptions.symmetricDifference()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func NSEnumerationOptions.contains()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func NSEnumerationOptions.isSubset()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func NSEnumerationOptions.isSuperset()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func NSEnumerationOptions.isDisjoint()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func NSEnumerationOptions.subtracting()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func NSEnumerationOptions.isStrictSuperset()": .method { receiver, args in
        guard args.count == 1 else {
    ...
    "func NSEnumerationOptions.isStrictSubset()": .method { receiver, args in
        guard args.count == 1 else {
