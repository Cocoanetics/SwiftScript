...
#if canImport(Darwin)
        // Entries that depend on Apple-only stdlib surface
        // (`String.propertyList`, `LocalizedStringResource`,
        // `String.Index.debugDescription`).
        dicts.append(StdlibBridges.stringApple)
        dicts.append(StdlibBridges.stringIndexApple)
#endif
