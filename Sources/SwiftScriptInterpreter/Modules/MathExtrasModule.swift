...
public struct MathExtrasModule: BuiltinModule {
    ...
    private func registerDoubleMethods(_ i: Interpreter) {
        i.bridges["func Double.clamped()"] = .method { recv, args in
        ...
        i.bridges["func Double.truncatingRemainder()"] = .method { recv, args in
        ...
        i.bridges["var Double.sign"] = .computed { recv in
    ...
    private func registerArrayReductions(_ i: Interpreter) {
        i.bridges["func Array.sum()"] = .method { recv, args in
        ...
        i.bridges["func Array.product()"] = .method { recv, args in
        ...
        i.bridges["func Array.average()"] = .method { recv, args in
